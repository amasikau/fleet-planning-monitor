...
const actionColors: Record<string, string> = {
  ...
  unblock: "bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400",
  ...
  const filtered = useMemo(() => {
    ...
    result = [...result].sort((a, b) => {
      ...
      if (sortKey === "timestamp") {
        ...
        cmp = AUDIT_ACTION_LABELS[a.action].localeCompare(AUDIT_ACTION_LABELS[b.action], "ru")
      } else {
          ...
          <div className="min-w-[700px]">
            ...
            <TableHeader>
              <TableRow>
                ...
                {/* Time — click opens date range picker */}

...
async function main() {
  ...
  const kamazDump = await prisma.fleetVehicle.create({
    data: {
      ...
      currentSite: 'Ремонт участка обхода Гомеля, км 12+400 — 18+800',
  ...
  const mazDump = await prisma.fleetVehicle.create({
    data: {
      ...
      fuelLevelPercent: 38,
      baseName: 'Гомельская дорожная база',
      currentSite: 'Асфальтирование улицы Советской',
  ...
  const mazCrane = await prisma.fleetVehicle.create({
    data: {
      ...
      fuelLevelPercent: 61,
      baseName: 'Гомельская дорожная база',
      currentSite: 'Фрезерование покрытия на проспекте Победы',
  ...
  const jcbExcavator = await prisma.fleetVehicle.create({
    data: {
      ...
      fuelLevelPercent: 19,
      baseName: 'Гомельская дорожная база',
      currentSite: 'Устройство основания подъезда к промзоне Южная',
  ...
  const hyundaiTucson = await prisma.fleetVehicle.create({
    data: {
      ...
      fuelLevelPercent: 83,
      baseName: 'Гомельская дорожная база',
      currentSite: 'Ямочный ремонт уличной сети Гомеля',
  ...
  const additionalFleetVehicles: Prisma.FleetVehicleCreateInput[] = [
    {
      name: 'МАЗ 6501C9-8520-005',
      brand: 'МАЗ',
      model: '6501C9-8520-005',
      plateNumber: '2468 AX-3',
      vin: 'Y3M6501C9R0002468',
      type: 'dump_truck',
      status: 'active',
      year: 2022,
      odometerKm: 61200,
      fuelLevelPercent: 81,
      baseName: 'Гомельская дорожная база',
      currentSite: 'Резерв подвоза асфальтобетонной смеси',
      nextMaintenanceAt: new Date('2026-07-04T08:00:00.000Z'),
      nextMaintenanceKm: 62000,
      insuranceExpiresAt: new Date('2026-09-10T00:00:00.000Z'),
      diagnosticsExpiresAt: new Date('2026-09-25T00:00:00.000Z'),
      notes: 'Резервный самосвал для подмены на этапах подвоза смеси.',
    },
    {
      name: 'КАМАЗ 6520-6041-43',
      brand: 'КАМАЗ',
      model: '6520-6041-43',
      plateNumber: '3581 BE-3',
      vin: 'XTC652043R0003581',
      type: 'dump_truck',
      status: 'active',
      year: 2020,
      odometerKm: 93800,
      fuelLevelPercent: 66,
      baseName: 'Гомельская дорожная база',
      currentSite: 'Резерв вывоза фрезерата',
      nextMaintenanceAt: new Date('2026-07-12T08:00:00.000Z'),
      nextMaintenanceKm: 94500,
      insuranceExpiresAt: new Date('2026-10-02T00:00:00.000Z'),
      diagnosticsExpiresAt: new Date('2026-10-15T00:00:00.000Z'),
      notes: 'Самосвал для фрезерования и устройства основания.',
    },
    {
      name: 'МАЗ 5550C3-581-000',
      brand: 'МАЗ',
      model: '5550C3-581-000',
      plateNumber: '9024 EP-3',
      vin: 'Y3M5550C3R0009024',
      type: 'dump_truck',
      status: 'reserve',
      year: 2019,
      odometerKm: 101500,
      fuelLevelPercent: 58,
      baseName: 'Гомельская дорожная база',
      currentSite: 'Резерв дорожного участка',
      nextMaintenanceAt: new Date('2026-07-20T08:00:00.000Z'),
      nextMaintenanceKm: 102000,
      insuranceExpiresAt: new Date('2026-11-05T00:00:00.000Z'),
      diagnosticsExpiresAt: new Date('2026-11-18T00:00:00.000Z'),
      notes: 'Резерв для автоматического переназначения при дефиците.',
    },
    {
      name: 'Амкодор 352C',
      brand: 'Амкодор',
      model: '352C',
      plateNumber: '1176 AO-3',
      vin: 'Y4A352CR0001176',
      type: 'loader',
      status: 'active',
      year: 2021,
      ...
      fuelLevelPercent: 73,
      baseName: 'Гомельская дорожная база',
      currentSite: 'Погрузка щебня и фрезерата',
      nextMaintenanceAt: new Date('2026-07-01T08:00:00.000Z'),
      nextMaintenanceKm: 54000,
      insuranceExpiresAt: new Date('2026-09-28T00:00:00.000Z'),
      diagnosticsExpiresAt: new Date('2026-10-09T00:00:00.000Z'),
      notes: 'Фронтальный погрузчик для материальных этапов.',
    },
    {
      name: 'Hyundai HL770-9S',
      brand: 'Hyundai',
      model: 'HL770-9S',
      plateNumber: '3820 KA-3',
      vin: 'HHKHL7709R0003820',
      type: 'loader',
      status: 'reserve',
      year: 2018,
      odometerKm: 82300,
      fuelLevelPercent: 49,
      baseName: 'Гомельская дорожная база',
      currentSite: 'Резерв погрузки материалов',
      nextMaintenanceAt: new Date('2026-07-18T08:00:00.000Z'),
      nextMaintenanceKm: 83000,
      insuranceExpiresAt: new Date('2026-10-21T00:00:00.000Z'),
      diagnosticsExpiresAt: new Date('2026-11-03T00:00:00.000Z'),
      notes: 'Резервный погрузчик для смены при ремонте основной техники.',
    },
    {
      name: 'Hyundai R220LC-9S',
      brand: 'Hyundai',
      model: 'R220LC-9S',
      plateNumber: '4172 KH-3',
      vin: 'HHKR2209SR0004172',
      type: 'excavator',
      status: 'active',
      year: 2019,
      odometerKm: 87400,
      fuelLevelPercent: 62,
      baseName: 'Гомельская дорожная база',
      currentSite: 'Резерв земляных работ',
      nextMaintenanceAt: new Date('2026-07-07T08:00:00.000Z'),
      nextMaintenanceKm: 88000,
      insuranceExpiresAt: new Date('2026-10-18T00:00:00.000Z'),
      diagnosticsExpiresAt: new Date('2026-10-31T00:00:00.000Z'),
      notes: 'Экскаватор для разработки грунта и водоотводных канав.',
    },
    {
      name: 'LiuGong 922E',
      brand: 'LiuGong',
      model: '922E',
      plateNumber: '5640 HM-3',
      vin: 'CLG922ER0005640',
      type: 'excavator',
      status: 'reserve',
      year: 2020,
      ...
      fuelLevelPercent: 76,
      baseName: 'Гомельская дорожная база',
      currentSite: 'Резерв разработки грунта',
      nextMaintenanceAt: new Date('2026-08-02T08:00:00.000Z'),
      nextMaintenanceKm: 70000,
      insuranceExpiresAt: new Date('2026-11-10T00:00:00.000Z'),
      diagnosticsExpiresAt: new Date('2026-11-22T00:00:00.000Z'),
      notes: 'Резервный гусеничный экскаватор.',
    },
    {
      name: 'Shantui SD22',
      brand: 'Shantui',
      model: 'SD22',
      plateNumber: '7305 KC-3',
      vin: 'SSSD22R0007305',
      type: 'bulldozer',
      status: 'reserve',
      year: 2017,
      ...
      baseName: 'Гомельская дорожная база',
      currentSite: 'Резерв земляных работ',
      nextMaintenanceAt: new Date('2026-08-05T08:00:00.000Z'),
      nextMaintenanceKm: 89200,
      insuranceExpiresAt: new Date('2026-11-26T00:00:00.000Z'),
      diagnosticsExpiresAt: new Date('2026-12-08T00:00:00.000Z'),
      notes: 'Резервный бульдозер для планировки земляного полотна.',
    },
    {
      name: 'Vogele Super 1600-3',
      brand: 'Vogele',
      model: 'Super 1600-3',
      plateNumber: '2857 AC-3',
      vin: 'WVG16003R0002857',
      type: 'asphalt_paver',
      status: 'reserve',
      year: 2020,
      odometerKm: 42600,
      fuelLevelPercent: 88,
      baseName: 'Гомельская дорожная база',
      currentSite: 'Резерв укладки покрытия',
      nextMaintenanceAt: new Date('2026-07-15T08:00:00.000Z'),
      nextMaintenanceKm: 43200,
      insuranceExpiresAt: new Date('2026-10-11T00:00:00.000Z'),
      diagnosticsExpiresAt: new Date('2026-10-24T00:00:00.000Z'),
      notes: 'Асфальтоукладчик для подмены при ремонте основной машины.',
    },
    {
      name: 'Hamm HD+ 90i VV',
      brand: 'Hamm',
      model: 'HD+ 90i VV',
      plateNumber: '6491 HB-3',
      vin: 'HHD90IVVR0006491',
      type: 'road_roller',
      status: 'active',
      year: 2021,
      odometerKm: 31500,
      fuelLevelPercent: 79,
      baseName: 'Гомельская дорожная база',
      currentSite: 'Резерв уплотнения покрытия',
      nextMaintenanceAt: new Date('2026-07-09T08:00:00.000Z'),
      nextMaintenanceKm: 32000,
      insuranceExpiresAt: new Date('2026-09-30T00:00:00.000Z'),
      diagnosticsExpiresAt: new Date('2026-10-12T00:00:00.000Z'),
      notes: 'Двухвальцовый каток для асфальтобетонного покрытия.',
    },
    {
      name: 'Ammann ASC 110',
      brand: 'Ammann',
      model: 'ASC 110',
      plateNumber: '7742 BT-3',
      vin: 'AASC110R0007742',
      type: 'road_roller',
      status: 'reserve',
      year: 2018,
      ...
      fuelLevelPercent: 47,
      baseName: 'Гомельская дорожная база',
      currentSite: 'Резерв уплотнения основания',
      nextMaintenanceAt: new Date('2026-07-28T08:00:00.000Z'),
      nextMaintenanceKm: 60000,
      insuranceExpiresAt: new Date('2026-10-20T00:00:00.000Z'),
      diagnosticsExpiresAt: new Date('2026-11-01T00:00:00.000Z'),
      notes: 'Грунтовый каток для основания и земляного полотна.',
    },
    {
      name: 'Wirtgen W 150 CF',
      brand: 'Wirtgen',
      model: 'W 150 CF',
      plateNumber: '8306 KM-3',
      vin: 'W150CFR0008306',
      type: 'road_milling_machine',
      status: 'reserve',
      year: 2019,
      ...
      fuelLevelPercent: 69,
      baseName: 'Гомельская дорожная база',
      currentSite: 'Резерв фрезерования покрытия',
      nextMaintenanceAt: new Date('2026-08-11T08:00:00.000Z'),
      nextMaintenanceKm: 47800,
      insuranceExpiresAt: new Date('2026-11-14T00:00:00.000Z'),
      diagnosticsExpiresAt: new Date('2026-11-26T00:00:00.000Z'),
      notes: 'Резервная дорожная фреза для коротких участков.',
    },
    {
      name: 'ДЗ-98В',
      brand: 'ДЗ',
      model: '98В',
      plateNumber: '9408 CK-3',
      vin: 'XDZ98VR0009408',
      type: 'motor_grader',
      status: 'active',
      year: 2016,
      ...
      fuelLevelPercent: 63,
      baseName: 'Гомельская дорожная база',
      currentSite: 'Профилирование основания',
      nextMaintenanceAt: new Date('2026-08-16T08:00:00.000Z'),
      nextMaintenanceKm: 117500,
      insuranceExpiresAt: new Date('2026-11-20T00:00:00.000Z'),
      diagnosticsExpiresAt: new Date('2026-12-04T00:00:00.000Z'),
      notes: 'Автогрейдер для основания и планировки полотна.',
    },
    {
      name: 'ГАЗон Next C41R13',
      brand: 'ГАЗ',
      model: 'C41R13',
      plateNumber: '1529 HA-3',
      vin: 'X96C41R13R0001529',
      type: 'flatbed_truck',
      status: 'active',
      year: 2022,
      odometerKm: 33600,
      fuelLevelPercent: 71,
      baseName: 'Гомельская дорожная база',
      currentSite: 'Подвоз дорожных знаков и ограждений',
      nextMaintenanceAt: new Date('2026-07-22T08:00:00.000Z'),
      nextMaintenanceKm: 34200,
      insuranceExpiresAt: new Date('2026-10-28T00:00:00.000Z'),
      diagnosticsExpiresAt: new Date('2026-11-09T00:00:00.000Z'),
      notes: 'Бортовой автомобиль для временной организации движения.',
    },
    {
      name: 'Geely Atlas Pro',
      brand: 'Geely',
      model: 'Atlas Pro',
      plateNumber: '2164 TA-3',
      vin: 'L6T7824R0002164',
      type: 'passenger_car',
      status: 'active',
      year: 2023,
      ...
      fuelLevelPercent: 82,
      baseName: 'Гомельская дорожная база',
      currentSite: 'Контроль дорожных объектов',
      nextMaintenanceAt: new Date('2026-08-01T08:00:00.000Z'),
      nextMaintenanceKm: 30000,
      insuranceExpiresAt: new Date('2026-12-12T00:00:00.000Z'),
      diagnosticsExpiresAt: new Date('2026-12-26T00:00:00.000Z'),
      notes: 'Легковой автомобиль сопровождения и контроля качества.',
    },
    {
      name: 'Lada Niva Travel',
      brand: 'Lada',
      model: 'Niva Travel',
      plateNumber: '4319 OP-3',
      vin: 'XTA2123R0004319',
      type: 'passenger_car',
      status: 'reserve',
      year: 2021,
      ...
      fuelLevelPercent: 57,
      baseName: 'Гомельская дорожная база',
      currentSite: 'Резерв выездного контроля',
      nextMaintenanceAt: new Date('2026-08-19T08:00:00.000Z'),
      nextMaintenanceKm: 52500,
      insuranceExpiresAt: new Date('2026-11-30T00:00:00.000Z'),
      diagnosticsExpiresAt: new Date('2026-12-13T00:00:00.000Z'),
      notes: 'Резервная машина для объездов и оперативных выездов.',
    },
    {
      name: 'МАЗ 5337 КС-3577',
      brand: 'МАЗ',
      model: '5337 КС-3577',
      plateNumber: '3742 OA-3',
      vin: 'Y3M5337KSR0003742',
      type: 'crane',
      status: 'reserve',
      year: 2018,
      odometerKm: 56600,
      fuelLevelPercent: 64,
      baseName: 'Гомельская дорожная база',
      currentSite: 'Резерв монтажа временных конструкций',
      nextMaintenanceAt: new Date('2026-08-21T08:00:00.000Z'),
      nextMaintenanceKm: 57200,
      insuranceExpiresAt: new Date('2026-12-02T00:00:00.000Z'),
      diagnosticsExpiresAt: new Date('2026-12-16T00:00:00.000Z'),
      notes: 'Резервный автокран для разгрузки плит и дорожных ограждений.',
    },
    {
      name: 'МТЗ 82.1',
      brand: 'МТЗ',
      model: '82.1',
      plateNumber: '5186 MP-3',
      vin: 'MTZ821R0005186',
      type: 'tractor',
      status: 'active',
      year: 2020,
      ...
      fuelLevelPercent: 72,
      baseName: 'Гомельская дорожная база',
      currentSite: 'Подготовка обочин и временных съездов',
      nextMaintenanceAt: new Date('2026-08-24T08:00:00.000Z'),
      nextMaintenanceKm: 42000,
      insuranceExpiresAt: new Date('2026-12-05T00:00:00.000Z'),
      diagnosticsExpiresAt: new Date('2026-12-19T00:00:00.000Z'),
      notes: 'Трактор с навесным оборудованием для вспомогательных работ.',
    },
    {
      name: 'Беларус 1221.3',
      brand: 'Беларус',
      model: '1221.3',
      plateNumber: '6073 TK-3',
      vin: 'BLR12213R0006073',
      type: 'tractor',
      status: 'reserve',
      year: 2019,
      odometerKm: 53800,
      fuelLevelPercent: 59,
      baseName: 'Гомельская дорожная база',
      currentSite: 'Резерв работ на обочинах',
      nextMaintenanceAt: new Date('2026-09-02T08:00:00.000Z'),
      nextMaintenanceKm: 54500,
      insuranceExpiresAt: new Date('2026-12-10T00:00:00.000Z'),
      diagnosticsExpiresAt: new Date('2026-12-23T00:00:00.000Z'),
      notes: 'Резервный трактор для буксировки прицепного оборудования.',
    },
    {
      name: 'МАЗ 6430C9-520-012',
      brand: 'МАЗ',
      model: '6430C9-520-012',
      plateNumber: '7251 KH-3',
      vin: 'Y3M6430C9R0007251',
      type: 'truck_tractor',
      status: 'reserve',
      year: 2020,
      odometerKm: 132400,
      fuelLevelPercent: 61,
      baseName: 'Гомельская дорожная база',
      currentSite: 'Резерв перебазировки тяжелой техники',
      nextMaintenanceAt: new Date('2026-09-07T08:00:00.000Z'),
      nextMaintenanceKm: 133000,
      insuranceExpiresAt: new Date('2026-12-18T00:00:00.000Z'),
      diagnosticsExpiresAt: new Date('2026-12-30T00:00:00.000Z'),
      notes: 'Резервный седельный тягач для перевозки дорожной техники.',
    },
    {
      name: 'МАЗ 938662-043',
      brand: 'МАЗ',
      model: '938662-043',
      plateNumber: '8194 CP-3',
      vin: 'Y3M938662R0008194',
      type: 'semi_trailer',
      status: 'active',
      year: 2021,
      odometerKm: 0,
      fuelLevelPercent: 100,
      baseName: 'Гомельская дорожная база',
      currentSite: 'Перевозка катков и малой техники',
      nextMaintenanceAt: new Date('2026-09-11T08:00:00.000Z'),
      nextMaintenanceKm: 0,
      insuranceExpiresAt: new Date('2026-12-21T00:00:00.000Z'),
      diagnosticsExpiresAt: new Date('2027-01-04T00:00:00.000Z'),
      notes: 'Дополнительный полуприцеп для перебазировки техники.',
    },
    {
      name: 'ГАЗ Соболь NN',
      brand: 'ГАЗ',
      model: 'Соболь NN',
      plateNumber: '9402 EH-3',
      vin: 'X96SOBOLNR0009402',
      type: 'van',
      status: 'active',
      year: 2023,
      odometerKm: 18400,
      fuelLevelPercent: 84,
      baseName: 'Гомельская дорожная база',
      currentSite: 'Выездное снабжение ремонтных бригад',
      nextMaintenanceAt: new Date('2026-09-14T08:00:00.000Z'),
      nextMaintenanceKm: 19000,
      insuranceExpiresAt: new Date('2027-01-09T00:00:00.000Z'),
      diagnosticsExpiresAt: new Date('2027-01-20T00:00:00.000Z'),
      notes: 'Фургон снабжения для инструмента, конусов и средств связи.',
    },
    {
      name: 'УАЗ Пикап',
      brand: 'УАЗ',
      model: 'Пикап',
      plateNumber: '1468 PK-3',
      vin: 'XTT23632R0001468',
      type: 'pickup',
      status: 'active',
      year: 2021,
      odometerKm: 46700,
      fuelLevelPercent: 68,
      baseName: 'Гомельская дорожная база',
      currentSite: 'Оперативный контроль дорожных объектов',
      nextMaintenanceAt: new Date('2026-09-18T08:00:00.000Z'),
      nextMaintenanceKm: 47500,
      insuranceExpiresAt: new Date('2027-01-12T00:00:00.000Z'),
      diagnosticsExpiresAt: new Date('2027-01-24T00:00:00.000Z'),
      notes: 'Пикап сопровождения для выезда на участки вне городской сети.',
    },
    {
      name: 'Toyota Hilux',
      brand: 'Toyota',
      model: 'Hilux',
      plateNumber: '2685 HT-3',
      vin: 'MR0BA3CDR0002685',
      type: 'pickup',
      status: 'reserve',
      year: 2022,
      odometerKm: 39200,
      fuelLevelPercent: 77,
      baseName: 'Гомельская дорожная база',
      currentSite: 'Резерв сопровождения дорожных работ',
      nextMaintenanceAt: new Date('2026-09-22T08:00:00.000Z'),
      nextMaintenanceKm: 40000,
      insuranceExpiresAt: new Date('2027-01-18T00:00:00.000Z'),
      diagnosticsExpiresAt: new Date('2027-01-31T00:00:00.000Z'),
      notes: 'Резервный пикап для инженерного контроля и связи.',
    },
  ];
  ...
  const [
    ...
    mazDumpStandby,
    amkodorLoaderActive,
    hyundaiLoaderReserve,
    hyundaiExcavatorReserve,
    liugongExcavatorReserve,
    shantuiBulldozerReserve,
    vogelePaverReserve,
    hammRoller,
    ammannRoller,
    wirtgenMillingReserve,
    dzGrader,
    gazonFlatbed,
    geelyAtlas,
    ladaNiva,
    mazCraneReserve,
    mtzTractor,
    belarusTractorReserve,
    mazTractorReserve,
    mazSemiTrailerActive,
    gazSableVan,
    uazPickup,
    toyotaPickupReserve,
  ] = await Promise.all(
    additionalFleetVehicles.map((data) => prisma.fleetVehicle.create({ data })),
  );
    ...
    data: [
      {
        ...
        vehicleLabel: 'МАЗ 6516B9-480-000 · 2213 AK-3',
        performedById: admin.id,
      ...
      },
      {
        ...
        vehicleLabel: 'КАМАЗ 65201-53 · 1842 AB-3',
        performedById: admin.id,
      ...
      },
      {
        ...
        vehicleLabel: 'КАМАЗ 65201-53 · 1842 AB-3',
        performedById: admin.id,
        details: 'Создана единица техники КАМАЗ 65201-53 · 1842 AB-3',
      },
      {
        timestamp: new Date('2026-04-03T15:40:00.000Z'),
        action: 'edit',
        targetVehicleId: jcbExcavator.id,
        vehicleLabel: 'JCB JS220SC T2 · 4675 EB-3',
        performedById: admin.id,
      ...
      },
      {
        ...
        vehicleLabel: 'JCB JS220SC T2 · 4675 EB-3',
        performedById: admin.id,
        details: 'Создана единица техники JCB JS220SC T2 · 4675 EB-3',
      },
      {
        timestamp: new Date('2026-04-02T16:20:00.000Z'),
        action: 'create',
        targetVehicleId: gazVan.id,
        vehicleLabel: 'ГАЗ C45R02 CERMES · 5124 AT-3',
        performedById: admin.id,
        details: 'Создана единица техники ГАЗ C45R02 CERMES · 5124 AT-3',
      },
      {
      ...
      },
      {
        ...
        vehicleLabel: 'МАЗ 6516B9-480-000 · 2213 AK-3',
        performedById: admin.id,
        details: 'Создана единица техники МАЗ 6516B9-480-000 · 2213 AK-3',
      },
    ],
  });
  ...
  const m5Repair = await prisma.constructionSite.create({
    data: {
      name: 'Ремонт участка обхода Гомеля, км 12+400 — 18+800',
      workType: 'Капитальный ремонт дорожного покрытия',
      city: 'Гомель',
      address:
        'Республика Беларусь, Гомельский район, автомобильная дорога Н-4098, км 12+400 — 18+800',
      latitude: 52.5138,
      longitude: 30.9197,
  ...
  const centralStreet = await prisma.constructionSite.create({
    data: {
      name: 'Асфальтирование улицы Советской',
      workType: 'Укладка асфальтобетонного покрытия',
      city: 'Гомель',
      address: 'Республика Беларусь, г. Гомель, ул. Советская, участок 48–72',
      latitude: 52.4348,
      longitude: 30.9935,
  ...
  const avenueMilling = await prisma.constructionSite.create({
    data: {
      name: 'Фрезерование покрытия на проспекте Победы',
      workType: 'Фрезерование и подготовка карты ремонта',
      city: 'Гомель',
      address: 'Республика Беларусь, г. Гомель, проспект Победы, участок 18–36',
      latitude: 52.4306,
      longitude: 31.0134,
  ...
  const potholeProgram = await prisma.constructionSite.create({
    data: {
      name: 'Ямочный ремонт уличной сети Гомеля',
      workType: 'Локальный ремонт покрытия',
      city: 'Гомель',
      address: 'Республика Беларусь, г. Гомель, Новобелицкий район',
      latitude: 52.3909,
      longitude: 31.0522,
  ...
  const eastBaseRoad = await prisma.constructionSite.create({
    data: {
      name: 'Устройство основания подъезда к промзоне Южная',
      workType: 'Устройство основания дорожной одежды',
      city: 'Гомель',
      address: 'Республика Беларусь, г. Гомель, промзона Южная, подъезд 2',
      latitude: 52.3837,
      longitude: 30.9736,
  ...
  await prisma.siteVehicle.createMany({
    data: [
      ...
      { siteId: m5Repair.id, vehicleId: mazDumpReserve.id },
      { siteId: m5Repair.id, vehicleId: kamazDumpFrez.id },
      { siteId: m5Repair.id, vehicleId: mazCrane.id },
      { siteId: m5Repair.id, vehicleId: mazCraneReserve.id },
      { siteId: m5Repair.id, vehicleId: mazTractorReserve.id },
      { siteId: m5Repair.id, vehicleId: mazSemiTrailerActive.id },
      { siteId: m5Repair.id, vehicleId: jcbExcavator.id },
      { siteId: m5Repair.id, vehicleId: hyundaiExcavatorReserve.id },
      { siteId: centralStreet.id, vehicleId: mazDump.id },
      { siteId: centralStreet.id, vehicleId: mazDumpStandby.id },
      { siteId: centralStreet.id, vehicleId: gazVan.id },
      { siteId: centralStreet.id, vehicleId: vogelePaver.id },
      { siteId: centralStreet.id, vehicleId: vogelePaverReserve.id },
      { siteId: centralStreet.id, vehicleId: bomagRoller.id },
      { siteId: centralStreet.id, vehicleId: hammRoller.id },
      { siteId: centralStreet.id, vehicleId: gazSableVan.id },
      { siteId: avenueMilling.id, vehicleId: wirtgenMilling.id },
      { siteId: avenueMilling.id, vehicleId: wirtgenMillingReserve.id },
      { siteId: potholeProgram.id, vehicleId: hyundaiTucson.id },
      { siteId: potholeProgram.id, vehicleId: geelyAtlas.id },
      { siteId: potholeProgram.id, vehicleId: ladaNiva.id },
      { siteId: potholeProgram.id, vehicleId: uazPickup.id },
      { siteId: potholeProgram.id, vehicleId: toyotaPickupReserve.id },
      { siteId: potholeProgram.id, vehicleId: gazFlatbed.id },
      { siteId: potholeProgram.id, vehicleId: gazonFlatbed.id },
      { siteId: eastBaseRoad.id, vehicleId: hyundaiExcavator.id },
      { siteId: eastBaseRoad.id, vehicleId: liugongExcavatorReserve.id },
      { siteId: eastBaseRoad.id, vehicleId: shantuiBulldozer.id },
      { siteId: eastBaseRoad.id, vehicleId: shantuiBulldozerReserve.id },
      { siteId: eastBaseRoad.id, vehicleId: amkodorLoader.id },
      { siteId: eastBaseRoad.id, vehicleId: amkodorLoaderActive.id },
      { siteId: eastBaseRoad.id, vehicleId: hyundaiLoaderReserve.id },
      { siteId: eastBaseRoad.id, vehicleId: ammannRoller.id },
      { siteId: eastBaseRoad.id, vehicleId: dzGrader.id },
      { siteId: eastBaseRoad.id, vehicleId: mtzTractor.id },
      { siteId: eastBaseRoad.id, vehicleId: belarusTractorReserve.id },
    ],
  });
    ...
    data: [
      {
        ...
        siteLabel: 'Ремонт участка обхода Гомеля',
        performedById: petrov.id,
        details: 'Назначена техника: МАЗ 5337A2-340P (3098 AM-3)',
      },
      {
        timestamp: new Date('2026-04-06T10:20:00.000Z'),
        action: 'edit',
        targetSiteId: centralStreet.id,
        siteLabel: 'Асфальтирование улицы Советской',
        performedById: admin.id,
      ...
      },
      {
        ...
        siteLabel: 'Ямочный ремонт уличной сети Гомеля',
        performedById: sidorova.id,
      ...
      },
      {
        ...
        siteLabel: 'Ямочный ремонт уличной сети Гомеля',
        performedById: admin.id,
        details: 'Назначена техника: Hyundai Tucson (7341 AO-3)',
      },
      {
        ...
        siteLabel: 'Ямочный ремонт уличной сети Гомеля',
        performedById: admin.id,
        details: 'Создан объект «Ямочный ремонт уличной сети Гомеля»',
      },
      {
        ...
        siteLabel: 'Ремонт участка обхода Гомеля',
        performedById: admin.id,
        details: 'Назначена техника: КАМАЗ 65201-53 (1842 AB-3)',
      },
      {
        ...
        performedById: admin.id,
        details:
          'Создан объект «Ремонт участка обхода Гомеля, км 12+400 — 18+800»',
      },
      {
        timestamp: new Date('2026-04-02T15:30:00.000Z'),
        action: 'complete',
        targetSiteId: avenueMilling.id,
        siteLabel: 'Фрезерование покрытия на проспекте Победы',
        performedById: admin.id,
        details: 'Объект «Фрезерование покрытия на проспекте Победы» завершён',
      },
      {
        ...
        siteLabel: 'Асфальтирование улицы Советской',
        performedById: admin.id,
        details: 'Создан объект «Асфальтирование улицы Советской»',
      },
      {
        timestamp: new Date('2026-04-01T11:10:00.000Z'),
        action: 'create',
        targetSiteId: eastBaseRoad.id,
        siteLabel: 'Устройство основания подъезда к промзоне Южная',
        performedById: admin.id,
        details:
          'Создан объект «Устройство основания подъезда к промзоне Южная»',
      },
      {
        ...
        siteLabel: 'Фрезерование покрытия на проспекте Победы',
        performedById: admin.id,
        details: 'Создан объект «Фрезерование покрытия на проспекте Победы»',
      },
    ],
  });
